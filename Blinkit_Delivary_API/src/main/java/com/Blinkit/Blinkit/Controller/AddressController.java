...
public class AddressController {
	...
	public ResponseEntity<List<AddressDto>> getaddress(@RequestParam(value = "num")int num,@RequestParam(value="Size") int size) {
		return addressservice.getaddress(num,size);
	}
